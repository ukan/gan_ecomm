			...
			<div id="horizontalTab">
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp1.jpg') }}" alt="" />
								<div class="p-mask">
						...
						<div class="col-md-3 top-product-grids tp2">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp2.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp3">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp3.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp4.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp5">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/ip2.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp6">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/shp8.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp7">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/cap1.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/wap3.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="tab-1 resp-tab-content">
						<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp5.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp2">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp6.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp3">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp7.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp8.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/wp8.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/wp5.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/wp4.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/wp3.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="tab-1 resp-tab-content">
						<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp9.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp2">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp10.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp3">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp11.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp12.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
					...
					<div class="tab-1 resp-tab-content">
						<div class="col-md-3 top-product-grids tp1 animated wow slideInUp" data-wow-delay=".5s">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp13.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp2">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp14.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp3">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp15.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/tp16.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/cp5.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/cp4.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/cp7.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
						...
						<div class="col-md-3 top-product-grids tp4">
							<a href="single.html"><div class="product-img">
								<img src="{{ asset('assets/frontend/images/cp8.jpg') }}" alt="" />
								<div class="p-mask">
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
...
{!! Html::script('assets/frontend/js/easyResponsiveTabs.js') !!}
...
<div class="fandt">
					...
					<div class="wmuSliderWrapper">
						<article style="position: absolute; width: 100%; opacity: 0;"> 
							<div class="banner-wrap">
								<img src="{{ asset('assets/frontend/images/c1.png') }}" alt=" " class="img-responsive" />
						...
						<article style="position: absolute; width: 100%; opacity: 0;"> 
							<div class="banner-wrap">
								<img src="{{ asset('assets/frontend/images/c2.png') }}" alt=" " class="img-responsive" />
						...
						<article style="position: absolute; width: 100%; opacity: 0;">
							<div class="banner-wrap">
								<img src="{{ asset('assets/frontend/images/c3.png') }}" alt=" " class="img-responsive" />
	...
	{!! Html::script('assets/frontend/js/jquery.wmuSlider.js') !!} 
	<script>
		$('.example1').wmuSlider();         
	</script> 
</div>
...
<div class="top-brands">
	<div class="container">
		...
		<div class="sliderfig">
			<ul id="flexiselDemo1">			
				<li>
					<img src="{{ asset('assets/frontend/images/4.png') }}" alt=" " class="img-responsive" />
				</li>
				<li>
					<img src="{{ asset('assets/frontend/images/5.png') }}" alt=" " class="img-responsive" />
				</li>
				<li>
					<img src="{{ asset('assets/frontend/images/6.png') }}" alt=" " class="img-responsive" />
				</li>
				<li>
					<img src="{{ asset('assets/frontend/images/7.png') }}" alt=" " class="img-responsive" />
				</li>
				<li>
					<img src="{{ asset('assets/frontend/images/46.jpg') }}" alt=" " class="img-responsive" />
				</li>
			</ul>
		</div>
		<script type="text/javascript">
